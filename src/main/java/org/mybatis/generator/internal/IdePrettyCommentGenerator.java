 ...
 */
public class IdePrettyCommentGenerator extends DefaultCommentGenerator {
    ...
    public void addFieldComment(Field field,
        ...
        if (addRemarkComments && StringUtility.stringHasValue(remarks)) {
            ...
            for (int i = 0; i < remarkLines.length; i++) {
                ...
                if (i == 0) {
                    field.addJavaDocLine(" * Database Column Remarks: " + remarkLine + " <br>");
                } else {
                    field.addJavaDocLine(" *   " + remarkLine + " <br>");
                }
            }
        }
    ...
    private void getterSetterComment(Method method, IntrospectedColumn introspectedColumn) {
        String remarks = introspectedColumn.getRemarks();
        if (addRemarkComments && StringUtility.stringHasValue(remarks)) {
            String[] remarkLines = remarks.split(System.getProperty("line.separator"));  //$NON-NLS-1$
            for (int i = 0; i < remarkLines.length; i++) {
                String remarkLine = remarkLines[i];
                if (i == 0) {
                    method.addJavaDocLine(" * Database Column Remarks: " + remarkLine + " <br>");
                } else {
    ...
    public void addGetterComment(Method method,
        ...
        method.addJavaDocLine("/**"); //$NON-NLS-1$
        //method.addJavaDocLine(" * This method was generated by MyBatis Generator."); //$NON-NLS-1$
        getterSetterComment(method, introspectedColumn);
    ...
    private String getGeneratedAnnotation(String comment) {
        ...
        if (!suppressDate && !suppressAllComments) {
            buffer.append(", <br/>date: "); //$NON-NLS-1$
